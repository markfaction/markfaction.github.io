...
[Keywords: Toshiba MSX, Vintage Computer, MSX Basic, Assembly, Zilog Z80, Programming]

When I was young, I grew up surrounded by old computing and electronics magazines, issues from the 60’s, 70’s, and 80’s, a majority of them being the popular publication [creative computing](https://www.wikiwand.com/en/Creative_Computing_(magazine)). I used to read them voraciously, during a time when PCs (mostly running Windows 3.1) were just beginning to make an appearance in offices, schools, the occasional library, and to a somewhat rare extent, homes. 
