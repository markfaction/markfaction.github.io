...
The engineering practices we adopt and follow should be geared towards shrinking the number of ‘decisions in process’ at a given time, and to discover better ways of probing the real world to get faster insight and feedback. This will consequently help us reduce the foot print of mistakes we make in our decisions across the end-to-end value stream.
